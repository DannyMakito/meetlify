  ...
  return (
    <section className="w-full max-w-[264px]">
        ...
        <SheetTrigger asChild>
            <Image src='/icons/hamburger.svg' alt=' ' width={36} height={36} className='cursor-pointer sm:hidden'/>
        </SheetTrigger>
        ...
        <Link
            ...
            <Image src="/icons/logo.svg" width={32} height={32} alt='yuum' className='max-sm:size10'/>
